...
public class KelolaPesanan {
    ...
    public void ubahPesanan(
        ...
        if (pesanan != null) {
            ...
            // Mengubah data khusus Skincare
            else if (pesanan instanceof JastipSkincare) {

                JastipSkincare skincare =
                        (JastipSkincare) pesanan;

                skincare.setJenisKulit(
                        jenisKulit
                );

                skincare.setUkuranProduk(
                        ukuranProduk
                );
            }
